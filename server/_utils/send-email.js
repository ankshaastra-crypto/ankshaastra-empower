...
//   const finalLastNameSpellingChangeOk = (lastNameSpellingChangeOk && lastNameSpellingChangeOk.toString().trim()) || '';
...
//       </div>
//       ` : ''}
//       ${hasValue(finalLastNameSpellingChangeOk) ? `
//       <div class="detail-row">
//         <strong>OK to Change Last Name Spelling (if required):</strong>
//         <span>${finalLastNameSpellingChangeOk === 'yes' ? 'Yes' : 'No'}</span>
//       </div>
//       ` : ''}
//       <div class="detail-row">
...
//       details += finalLastNameSpellingChangeOk ? `<p><strong>OK to Change Last Name Spelling:</strong> ${finalLastNameSpellingChangeOk === 'yes' ? 'Yes' : 'No'}</p>` : '';
