...
// import { AppToaster } from "@/components/ui/toaster";import { Toaster as Sonner } from "@/components/ui/sonner";
    ...
    <BrowserRouter>
      <Suspense fallback={<div className="min-h-screen bg-background" />}>
        <Routes>
          ...
          <Route path="/payment/failed" element={<PaymentStatus />} />
          <Route path="/baby-name" element={<BabyNameLandingPage />} />
          {/* Shared Operations Console lives in the main Ankshaastra repo — never duplicate it here */}
