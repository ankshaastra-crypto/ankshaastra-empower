...
const BenefitsSection = () => {
  ...
  const benefits = [
    ...
    { icon: Users, title: "Trusted by 12000+ Families", text: "Join the growing community of conscious parents who have taken a deliberate step toward better name alignment with numerology." },
