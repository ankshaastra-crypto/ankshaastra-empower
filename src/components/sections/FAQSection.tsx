  ...
  const faqs = [
    {
      ...
      answer:
        "Your personalised Baby Name Numerology Report will be delivered to your WhatsApp / email address within 24–48 Hours following your purchase. Be sure to check your inbox's spam and promotions folders in case the report lands there.",
    },
    {
