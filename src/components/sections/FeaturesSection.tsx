  ...
  return (
    <section className="section-padding bg-muted/40" ref={ref}>
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto rounded-2xl p-6 md:p-8 border-2 border-accent/20 bg-accent/5 mb-10 md:mb-16">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-6 md:mb-8">
            ...
            <h3 className="text-2xl md:text-3xl lg:text-4xl font-heading font-bold text-foreground">
              This Report Is <span className="text-accent">For You If:</span>
            </h3>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
            {[
              ...
              <div key={i} className="flex items-start gap-3 bg-card rounded-xl p-4 border border-border hover:border-accent/40 transition-all duration-300">
                <span className="w-6 h-6 rounded-full bg-accent/15 flex items-center justify-center flex-shrink-0 mt-0.5">
                  <CheckCircle className="w-4 h-4 text-accent" />
                </span>
                <span className="text-foreground/85 text-sm md:text-base leading-relaxed">{item}</span>
              </div>
            ))}
          </div>
        </div>
