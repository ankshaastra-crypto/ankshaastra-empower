      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex items-center justify-center gap-4 md:gap-8 mb-8 md:mb-10">
          {badges.map((badge, i) => (
            <div
              key={i}
              className="flex items-center gap-3 rounded-xl px-5 py-4 md:px-8 md:py-5 bg-card border border-accent/30 shadow-lg"
            >
              ...
              <div className="text-left">
                ...
                <div className="text-xs md:text-sm text-foreground/70">{badge.sub}</div>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex gap-4 overflow-x-auto snap-x snap-mandatory pb-3 -mx-4 px-4 scroll-smooth [scrollbar-width:thin]">
            {reviews.map((review, i) => (
              <div
                key={i}
                className="snap-start shrink-0 w-[85%] sm:w-[60%] md:w-[32%] rounded-xl p-4 bg-card border border-border shadow-sm hover:shadow-md transition-all duration-300"
              >
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <GoogleIcon className="w-4 h-4 ml-auto" />
                </div>
