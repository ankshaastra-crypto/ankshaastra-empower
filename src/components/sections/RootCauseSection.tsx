...
const RootCauseSection = () => {
  ...
  const pillars = [
    { emoji: "🔢", title: "Numerology", desc: "Every letter carries a vibrational number that shapes personality & destiny from birth." },
    { emoji: "🕉️", title: "Vedic Principles", desc: "Ancient Indian wisdom aligns the name with the child's cosmic blueprint and life path." },
    { emoji: "📅", title: "Birth Date", desc: "Your baby's Mulank & Bhagyank guide which sounds are truly compatible with their energy." },
  ];

  return (
    <section className="py-12 md:py-20 lg:py-28 relative overflow-hidden" style={{ background: DARK_BG }} ref={ref}>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
            {pillars.map((pillar, index) => (
              <div key={index} className="relative bg-white/5 backdrop-blur-xl rounded-2xl p-6 md:p-8 border border-accent/20 text-center group hover:border-accent/50 transition-all duration-300 hover:-translate-y-1 gold-glow">
