                ...
                <div className="bg-card rounded-2xl p-8 shadow-card text-center animate-fade-in">
                  ...
                  {paymentData && (
                    <div className="bg-muted/50 rounded-xl p-6 mb-6 text-left">
                      <h3 className="font-semibold text-ink-black mb-3 text-sm uppercase tracking-wide">Order Details</h3>
                      <div className="space-y-3">
                        ...
                        {paymentData.customerName && (
                          <div className="flex flex-col sm:flex-row sm:justify-between gap-1">
                            <span className="text-muted-foreground text-sm shrink-0">Name:</span>
                            <span className="font-semibold text-ink-black text-sm sm:text-right">{paymentData.customerName}</span>
                          </div>
                        )}
                        {paymentData.packageType && (
                          <div className="flex flex-col sm:flex-row sm:justify-between gap-1">
                            <span className="text-muted-foreground text-sm shrink-0">Package:</span>
                            <span className="font-semibold text-ink-black text-sm sm:text-right">{packageNames[paymentData.packageType] || paymentData.packageType}</span>
                          </div>
                        )}
                        {paymentData.amount && (
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 justify-center">
                    ...
                    <a href={getWhatsAppLink()} target="_blank" rel="noopener noreferrer">
                      <Button variant="outline" className="w-full flex items-center gap-2 border-green-500 text-green-700 hover:bg-green-50">
